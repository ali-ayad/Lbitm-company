      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="mt-12 bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <p className="text-lg text-gray-800">
            <span className="font-semibold">Company Name:</span> Lbitm General
            Trading & Contracting Co. Ltd.
          </p>
          <p className="text-lg text-gray-800 mt-2">
            <span className="font-semibold">Founded:</span> April 19, 2009
          </p>
          <p className="text-lg text-gray-800 mt-2">
            <span className="font-semibold">Capital:</span> 5 Billion Iraqi
            Dinars
          </p>
          <p className="text-lg text-gray-800 mt-2">
            <span className="font-semibold">Business Type:</span> Construction &
            Electrical Contracting
          </p>
          <p className="text-lg text-gray-800 mt-2">
            <span className="font-semibold">Classification:</span> First-Class
            Construction, Fifth-Class Electrical
          </p>
          <p className="text-lg text-gray-800 mt-2">
            <span className="font-semibold">Managing Director:</span> Omar Issa
            Hanfoush Al-Jadhba
          </p>
          <p className="text-lg text-gray-800 mt-2">
            <span className="font-semibold">Headquarters:</span> Baghdad, Iraq –
            Al-Jamia District, 633-21-6
          </p>
        </div>
      </div>
    </section>
